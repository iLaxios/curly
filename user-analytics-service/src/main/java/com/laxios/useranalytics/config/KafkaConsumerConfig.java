package com.laxios.useranalytics.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UrlClickedEvent> consumerFactory() {
        JsonDeserializer<UrlClickedEvent> deserializer = new JsonDeserializer<>(UrlClickedEvent.class);
        deserializer.addTrustedPackages("*"); // trust all packages

        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "user-analytics-group");
